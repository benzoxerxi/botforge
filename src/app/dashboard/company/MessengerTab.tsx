      ...
      <div className="p-5 rounded-xl border border-[var(--color-border)] bg-[var(--color-card)]">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            <div className="w-6 h-6 rounded-full bg-[var(--color-accent)]/10 text-[var(--color-accent)] flex items-center justify-center shrink-0 text-xs font-bold">1</div>
            <div>
          ...
          {/* Step 2 */}
          <div className="flex gap-3">
            <div className="w-6 h-6 rounded-full bg-[var(--color-accent)]/10 text-[var(--color-accent)] flex items-center justify-center shrink-0 text-xs font-bold">2</div>
            <div>
          ...
          {/* Step 3 */}
          <div className="flex gap-3">
            <div className="w-6 h-6 rounded-full bg-[var(--color-accent)]/10 text-[var(--color-accent)] flex items-center justify-center shrink-0 text-xs font-bold">3</div>
            <div>
              <h4 className="text-xs font-semibold mb-1">Configure Webhook</h4>
              <p className="text-[11px] text-[var(--color-muted-foreground)] mb-2">
                In &quot;Messenger&quot; → &quot;Webhooks&quot;, set up a webhook with the following details:
              </p>
              <div className="space-y-2">
                <div className="flex items-center justify-between p-2.5 rounded-lg bg-[var(--color-background)] border border-[var(--color-border)]">
                  <div>
                    <div className="text-[9px] uppercase tracking-wider text-[var(--color-muted-foreground)]">Callback URL</div>
                    <div className="text-xs font-mono mt-0.5">{webhookUrl}</div>
                  </div>
                  <button onClick={() => copyToClipboard(webhookUrl)} className="p-1.5 rounded-lg hover:bg-[var(--color-muted)]/50 transition-all">
                    {copied ? <CheckCircle2 className="w-4 h-4 text-green-400" /> : <Copy className="w-4 h-4 text-[var(--color-muted-foreground)]" />}
                  </button>
                </div>
                <div className="flex items-center justify-between p-2.5 rounded-lg bg-[var(--color-background)] border border-[var(--color-border)]">
                  <div>
                    <div className="text-[9px] uppercase tracking-wider text-[var(--color-muted-foreground)]">Verify Token</div>
                    <div className="text-xs font-mono mt-0.5">{verifyToken}</div>
                  </div>
                  <button onClick={() => copyToClipboard(verifyToken)} className="p-1.5 rounded-lg hover:bg-[var(--color-muted)]/50 transition-all">
                    {copied ? <CheckCircle2 className="w-4 h-4 text-green-400" /> : <Copy className="w-4 h-4 text-[var(--color-muted-foreground)]" />}
                  </button>
                </div>
              </div>
          ...
          {/* Step 4 */}
          <div className="flex gap-3">
            <div className="w-6 h-6 rounded-full bg-[var(--color-accent)]/10 text-[var(--color-accent)] flex items-center justify-center shrink-0 text-xs font-bold">4</div>
            <div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 rounded-xl text-xs bg-[var(--color-background)] border border-[var(--color-border)] text-[var(--color-foreground)] placeholder-[var(--color-muted-foreground)] focus:outline-none focus:border-[var(--color-accent)]/50 transition-all font-mono"
                type="password"
              />
              <button
                className="px-4 py-2 rounded-xl text-xs font-medium bg-[var(--color-accent)] text-black hover:bg-[var(--color-accent)]/90 transition-all"
              >
                Save
              </button>
            </div>
